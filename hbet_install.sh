...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='hoolibet.conf'
CONFIGFOLDER='/root/.hoolibet'
COIN_DAEMON='hoolibetd'
COIN_CLI='hoolibet-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/hoolibet/hoolibet/releases/download/v1.0.0.0/hoolibet-1.0.0.0-x86_64-linux-gnu.tar.gz'
